	...
	if (mysqli_num_rows($check_user) == 0) {
		...
		if (isset($_POST['add'])) {
			...
			if (empty($post_username) || empty($post_password) || empty($post_nama)) {
				...
				$insert_user = mysqli_query($db, "INSERT INTO users (nama, username, password, level, registered, status, uplink) VALUES ('$post_nama', '$post_username', '$post_password', 'Member', '$date', 'Active', '$sess_username')");
				if ($insert_user == TRUE) {
					$msg_type = "success";
					$msg_content = "<b>Selamat</b> Member telah ditambahkan.<br /> Di <h>FAQCINE</h> Semoga harimu menyenangkan :) <br /><b>Nama:</b> $post_nama<br /><b>Username:</b> $post_username<br /><b>Password:</b> $post_password<br /><b>Level:</b> Member<br />";
				} else {
					$msg_type = "error";
									...
									<div class="card-body">
										...
										<form class="form-horizontal" role="form" method="POST">
											<div class="alert alert-info">
												- Silahkan daftarkan member melalui form dibawah ini <br/>
											</div>
