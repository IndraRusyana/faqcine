...
if (isset($_SESSION['user'])) {
    ...
    if (isset($_POST['daftar'])) {
        ...
        if (empty($post_nama) || empty($post_username) || empty($post_password) || empty($post_repeat_password)) {
            $msg_type = "error";
        ...
        // enkripsi password  
                ...
                $insert_user = mysqli_query($db, "INSERT INTO users (nama, username, password, level, registered, status, uplink) VALUES ('$post_nama', '$post_username', '$post_password', 'Member', '$date', 'Active', 'free_register')");
                if ($insert_user == TRUE) {
                    $msg_type = "success";
