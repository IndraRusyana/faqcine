                       ...
                       <div class="card">
                         <div class="card-body">
                                    ...
                                    <ol class="breadcrumb p-0 m-0">
                                        ...
                                        <li class="active">
                                          Tiket Bantuan FAQCINE , anda dapat menuliskan keluhan atau bantuan yang ingin anda sampaikan , cukup
										  isi form yang telah kami sediakan dibawah ini...
                                        </li>
                                    </ol>
                                    ...
                                    <div class="panel-body">
										...
										<form class="form-horizontal" role="form" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
											<div class="form-group">
												...
												<div class="col-md-10">
													<input type="text" name="subject" class="form-control" placeholder="JUDUL KELUHAN / BANTUAN">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-2 control-label">Message</label>
												<div class="col-md-10">
													<textarea name="message" class="form-control" placeholder="Tulis keluhan atau bantuan yang ingin anda pertanyakan , Staff kami akan segera membalasnya..." rows="3"></textarea>
												</div>
											</div>
											<div class="form-group">
